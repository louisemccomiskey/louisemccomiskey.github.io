...
function _runWebpack(taskOptions = {}) {
    ...
    if (args.hasOwnProperty('is-production') && args['is-production'] === true) {
        scriptSettings.uglifySettings.compress.drop_console = true;
        scriptSettings.uglifySettings.compress.drop_debugger = true;
        scriptSettings.uglifySettings.compress.unused = true;
