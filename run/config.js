...
config.taskConfiguration = {
        ...
        imageminPlugins: {
            ...
            svgo: {
                plugins: [
                    ...
                    {cleanupIDs: false },
                    {addClassesToSVGElement: {classNames: ['social-list--icon']}},
                    {removeUnknownsAndDefaults: {keepDataAttrs: true, unknownAttrs:false}}
                ]
            }
        }
    },
    ...
    scripts: {
        ...
        webpackSettings: {
            ...
            resolve: {
                alias: {
                    'utils': resolve.sync('./../js/src/utils.js'),
                    'config': resolve.sync('./../js/src/config.js'),
                    'eventBus': resolve.sync('./../js/src/eventBus.js'),
                    'decorators': resolve.sync('./../js/src/decorators.js'),
                    'baseView': resolve.sync('./../js/src/BaseView.js')
                }
            },
            plugins: [
