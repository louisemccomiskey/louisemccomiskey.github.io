...
build test images svg lint sscripts styles templates watch: node_modules
	npm run gulp -- $@;
...
.PHONY: default help setup build watch test lint images svg scripts styles templates
